          ...
          <form id="info-form">
            ...
            <div class="row">
              <div class="col-md-4 mb-3">
                ...
                <input name="name" type="text" value="<?php echo $u_fetch['name'] ?>" class="form-control shadow-none"onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode > 31 && event.charCode < 33)"  required>
              </div>
              <div class="col-md-4 mb-3">
                <label class="form-label">Phone Number</label>
                  <input name="phonenum" type="tel"value="<?php echo $u_fetch['phonenum'] ?>" class="form-control shadow-none" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
              ...
              <div class="col-md-4 mb-3">
                ...
                <input name="pincode" type="number" value="<?php echo $u_fetch['pincode'] ?>" class="form-control shadow-none" maxlength="06"  size="06" required>
              </div>
                ...
                <form id="pass-form">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input name="new_pass" type="password" class="form-control shadow-none" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\w\d\s]).{8,}$" required>
                        </div>
                        <div class="col-md-6 mb-4">
                            <label class="form-label">Confirm Password</label>
                            <input name="confirm_pass" type="password" class="form-control shadow-none" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[^\w\d\s]).{8,}$" required>
                        </div>
                    </div>
                    <button type="submit" class="btn text-white custom-bg shadow-none">Save Changes</button>
                </form>
