            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              ...
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="d-flex align-items-center justify-content-between mb-3" style="font-size: 18px;">
                  ...
                  <input class="form-control shadow-none shadow-none mb-3 checkin" value="<?php echo $checkin_default ?>"  type="date" name="checkin" id="checkin"onchange="chk_avail_filter()">
                <label class="form-label">Check-out</label>
                <input type="date" class="form-control shadow-none checkout" value="<?php echo $checkout_default ?>"  id="checkout"name="checkout" onchange="chk_avail_filter()">
              </div>
